...
INFO_FOR_BUY_COURSE = """Пользователь @{} хочет приобрести курс <u>{}</u> для 
...
😊 Переделай его и отправь заново преподавателю"""
...
HELP = """<u><b>Как оплатить курс?</b></u>
Для оплаты курса вам необходиомо:
1. Запустить бота при помощи команды <i>"/start"</i>
2. Выбрать необходимый курс.
3. Далее нажать на кнопку <i>"Оплатить курс".</i>
4. Ввести все необходимые данные.
5. Если всё было сделано верно, вам придет сообщение с моими контактами.
В течении дня я свяжусь с вами.


<u><b>Как узнать раписание занятий?</b></u>
Для того, чтобы узнать расписание вам необходимо:
1. После оплаты курса перейдите в личный кабинет студента - кнопка <i>"Перейти в кабинет студента".</i>
2. Далее вам придет сообщение с расписанием занятий.


<u><b>Если я пропустил урок, что делать? Хочу вспомнить пройденный материал, что делать?</b></u>
В этом случае предусмотренна кнопка <i>"Записи уроков"</i>.
Для этого, вам необходимо:

1. Перейти в личный кабинет студента -  кнопка <i>"Перейти в кабинет студента"</i>,
либо нажать на кнопку имеющегося у вас потока н-р: <i>"Знакомство с Python"</i>.
2. Затем нажать на кнопку <i>"Записи уроков"</i>.
3. Выбрать необходимый урок.
4. Если всё сделано верно, то вам придет видеозапись.


<u><b>Как получить или отправить домашнюю работу?</b></u>
Для этого, вам не обязательно связываться по телефону или ещё где-то c самим преподавателем.
Достаточно будет нажать кнопку <i>"Домашнее задание"</i> в личном кабинете студента.

1. Перейти в личный кабинет студента -  кнопка <i>"Перейти в кабинет студента"</i>, либо нажать на кнопку имеющегося у вас потока н-р: <i>"Знакомство с Python"</i>.
...
Как сделать?
1. Нажмите кнопку <i>"Отправить на проверку"</i>,которая находится после отправленного вам задания.
2. Сами выбирайте формат домашнего задания при отправке (фото, текст в сообщении и т.д).
3. В течении 24 часов преподаватель проверит ваше домашнее задание и отправит его вам с комментариями, указав ваши ошибки или то, какой вы всё-таки молодец.


<u><b>Как подключиться к занятию?</b></u>
Всё очень просто:

1. Перейти в личный кабинет студента -  кнопка <i>"Перейти в кабинет студента"</i>, либо нажать на кнопку имеющегося у вас потока(курса) н-р: <i>"Знакомство с Python"</i>.
2. Нажать кнопку <i>"Подключиться к занятию"</i>.
3. Далее нажать кнопку в сообщении <i>"Подключиться к конференции"</i>.
